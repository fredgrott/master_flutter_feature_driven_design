...
mixin _$Id {
  ...
  static Either<InvalidIdValue, ValidId> _verifyValueStep(
    ...
    final rightIdFailure = $idInstance
        .validateRightId($idValueHolder.toRightIdSubholder())
        .toNullable();

    if (rightIdFailure == null) {
    ...
    return left<InvalidIdValue, ValidId>(
      InvalidIdValue._(
          value: $idValueHolder.value, rightIdFailure: rightIdFailure),
    );
  }
...
mixin InvalidId implements Id, InvalidValueObject {
  ...
  TResult whenInvalid<TResult extends Object?>(
      {required TResult Function(RightIdFailure rightIdFailure)
          valueFailures}) {
  ...
  TResult maybeWhenInvalid<TResult extends Object?>(
      {TResult Function(RightIdFailure rightIdFailure)? valueFailures,
      required TResult Function() orElse}) {
    return maybeMap(
        invalidValue: valueFailures != null
            ? (invalidValue) => valueFailures(invalidValue.rightIdFailure)
            : null,
        orElse: orElse);
  }
...
class InvalidIdValue extends Id with InvalidId {
  InvalidIdValue._({required this.value, required this.rightIdFailure})
      : super._();

  @override
  final String value;

  final RightIdFailure rightIdFailure;

  @override
  List<ValueFailure> get failures => [rightIdFailure];

  @override
  List<Object?> get props => [value, rightIdFailure];
...
class _$IdValueHolder {
  ...
  _ValidateIdRightId toRightIdSubholder() {
    return _ValidateIdRightId(value: value);
  }
}

class _ValidateIdRightId {
  _ValidateIdRightId({required this.value});
